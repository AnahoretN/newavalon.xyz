...
const enUI = {
  ...
  copied: 'Copied!',
  inviteLinkDesc: 'Send link to a friend. Server address will configure automatically.',
  copyGameLinkDesc: 'Share this link so friends can join with your server settings pre-configured.',
  on: 'ON',
  off: 'OFF',
  dummyPlayers: 'Dummies',
  gridSize: 'Grid Size',
